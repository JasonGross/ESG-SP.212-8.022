...
By the way, before you start editing stuff in the folder I gave you, you'll need to do git pull origin master:master -f ; I was playing with the tree a bit.)

The template file is SP_212-8_022_Spring_2011_Problem_Set_00_Template.tex.  When LaTeXed, this file makes a problems pdf, a problems only .tex file, and a solutions .tex file.  You'll need to LaTeX the solutions file to get a solutions pdf.
