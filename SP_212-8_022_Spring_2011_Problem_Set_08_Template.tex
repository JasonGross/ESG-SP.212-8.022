...
A long flat conductor of width $a$ carries a sheet of current $i$ (see figure \ref{fig:flat}). You are asked to find the magnetic  field (direction and magnitude) near the center of its flat side and and very close to the surface, such that the distance R from the sheet is $R<<a$.
...
\begin{equation}
2B á L = \frac{4 \pi}{c} I_{enc} = \frac{4 \pi}{c} \frac{L i}{a}
\end{equation}
